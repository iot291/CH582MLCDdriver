...
C_SRCS += \
../src/新建文件夹/LVGL/examples/others/snapshot/lv_example_snapshot_1.c 

C_DEPS += \
./src/新建文件夹/LVGL/examples/others/snapshot/lv_example_snapshot_1.d 

OBJS += \
./src/新建文件夹/LVGL/examples/others/snapshot/lv_example_snapshot_1.o 



# Each subdirectory must supply rules for building sources it contributes
src/新建文件夹/LVGL/examples/others/snapshot/%.o: ../src/新建文件夹/LVGL/examples/others/snapshot/%.c
