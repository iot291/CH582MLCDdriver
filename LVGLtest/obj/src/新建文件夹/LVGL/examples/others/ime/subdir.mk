...
C_SRCS += \
../src/新建文件夹/LVGL/examples/others/ime/lv_example_ime_pinyin_1.c \
../src/新建文件夹/LVGL/examples/others/ime/lv_example_ime_pinyin_2.c 

C_DEPS += \
./src/新建文件夹/LVGL/examples/others/ime/lv_example_ime_pinyin_1.d \
./src/新建文件夹/LVGL/examples/others/ime/lv_example_ime_pinyin_2.d 

OBJS += \
./src/新建文件夹/LVGL/examples/others/ime/lv_example_ime_pinyin_1.o \
./src/新建文件夹/LVGL/examples/others/ime/lv_example_ime_pinyin_2.o 



# Each subdirectory must supply rules for building sources it contributes
src/新建文件夹/LVGL/examples/others/ime/%.o: ../src/新建文件夹/LVGL/examples/others/ime/%.c
