...
C_SRCS += \
../src/新建文件夹/LVGL/examples/porting/lv_port_disp.c \
../src/新建文件夹/LVGL/examples/porting/lv_port_fs.c \
../src/新建文件夹/LVGL/examples/porting/lv_port_indev.c 

C_DEPS += \
./src/新建文件夹/LVGL/examples/porting/lv_port_disp.d \
./src/新建文件夹/LVGL/examples/porting/lv_port_fs.d \
./src/新建文件夹/LVGL/examples/porting/lv_port_indev.d 

OBJS += \
./src/新建文件夹/LVGL/examples/porting/lv_port_disp.o \
./src/新建文件夹/LVGL/examples/porting/lv_port_fs.o \
./src/新建文件夹/LVGL/examples/porting/lv_port_indev.o 



# Each subdirectory must supply rules for building sources it contributes
src/新建文件夹/LVGL/examples/porting/%.o: ../src/新建文件夹/LVGL/examples/porting/%.c
