...
C_SRCS += \
../src/新建文件夹/LVGL/examples/widgets/arc/lv_example_arc_1.c \
../src/新建文件夹/LVGL/examples/widgets/arc/lv_example_arc_2.c 

C_DEPS += \
./src/新建文件夹/LVGL/examples/widgets/arc/lv_example_arc_1.d \
./src/新建文件夹/LVGL/examples/widgets/arc/lv_example_arc_2.d 

OBJS += \
./src/新建文件夹/LVGL/examples/widgets/arc/lv_example_arc_1.o \
./src/新建文件夹/LVGL/examples/widgets/arc/lv_example_arc_2.o 



# Each subdirectory must supply rules for building sources it contributes
src/新建文件夹/LVGL/examples/widgets/arc/%.o: ../src/新建文件夹/LVGL/examples/widgets/arc/%.c
