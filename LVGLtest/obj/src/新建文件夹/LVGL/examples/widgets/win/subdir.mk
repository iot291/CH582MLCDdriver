...
C_SRCS += \
../src/新建文件夹/LVGL/examples/widgets/win/lv_example_win_1.c 

C_DEPS += \
./src/新建文件夹/LVGL/examples/widgets/win/lv_example_win_1.d 

OBJS += \
./src/新建文件夹/LVGL/examples/widgets/win/lv_example_win_1.o 



# Each subdirectory must supply rules for building sources it contributes
src/新建文件夹/LVGL/examples/widgets/win/%.o: ../src/新建文件夹/LVGL/examples/widgets/win/%.c
