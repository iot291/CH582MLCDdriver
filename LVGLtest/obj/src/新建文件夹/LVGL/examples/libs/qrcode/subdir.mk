...
C_SRCS += \
../src/新建文件夹/LVGL/examples/libs/qrcode/lv_example_qrcode_1.c 

C_DEPS += \
./src/新建文件夹/LVGL/examples/libs/qrcode/lv_example_qrcode_1.d 

OBJS += \
./src/新建文件夹/LVGL/examples/libs/qrcode/lv_example_qrcode_1.o 



# Each subdirectory must supply rules for building sources it contributes
src/新建文件夹/LVGL/examples/libs/qrcode/%.o: ../src/新建文件夹/LVGL/examples/libs/qrcode/%.c
