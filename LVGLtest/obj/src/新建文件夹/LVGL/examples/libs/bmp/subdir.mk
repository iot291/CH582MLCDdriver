...
C_SRCS += \
../src/新建文件夹/LVGL/examples/libs/bmp/lv_example_bmp_1.c 

C_DEPS += \
./src/新建文件夹/LVGL/examples/libs/bmp/lv_example_bmp_1.d 

OBJS += \
./src/新建文件夹/LVGL/examples/libs/bmp/lv_example_bmp_1.o 



# Each subdirectory must supply rules for building sources it contributes
src/新建文件夹/LVGL/examples/libs/bmp/%.o: ../src/新建文件夹/LVGL/examples/libs/bmp/%.c
