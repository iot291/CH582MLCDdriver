...
C_SRCS += \
../src/新建文件夹/LVGL/examples/libs/gif/img_bulb_gif.c \
../src/新建文件夹/LVGL/examples/libs/gif/lv_example_gif_1.c 

C_DEPS += \
./src/新建文件夹/LVGL/examples/libs/gif/img_bulb_gif.d \
./src/新建文件夹/LVGL/examples/libs/gif/lv_example_gif_1.d 

OBJS += \
./src/新建文件夹/LVGL/examples/libs/gif/img_bulb_gif.o \
./src/新建文件夹/LVGL/examples/libs/gif/lv_example_gif_1.o 



# Each subdirectory must supply rules for building sources it contributes
src/新建文件夹/LVGL/examples/libs/gif/%.o: ../src/新建文件夹/LVGL/examples/libs/gif/%.c
