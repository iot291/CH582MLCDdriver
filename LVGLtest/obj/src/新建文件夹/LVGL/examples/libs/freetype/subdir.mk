...
C_SRCS += \
../src/新建文件夹/LVGL/examples/libs/freetype/lv_example_freetype_1.c 

C_DEPS += \
./src/新建文件夹/LVGL/examples/libs/freetype/lv_example_freetype_1.d 

OBJS += \
./src/新建文件夹/LVGL/examples/libs/freetype/lv_example_freetype_1.o 



# Each subdirectory must supply rules for building sources it contributes
src/新建文件夹/LVGL/examples/libs/freetype/%.o: ../src/新建文件夹/LVGL/examples/libs/freetype/%.c
