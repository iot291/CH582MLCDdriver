...
C_SRCS += \
../src/新建文件夹/LVGL/examples/libs/png/img_wink_png.c \
../src/新建文件夹/LVGL/examples/libs/png/lv_example_png_1.c 

C_DEPS += \
./src/新建文件夹/LVGL/examples/libs/png/img_wink_png.d \
./src/新建文件夹/LVGL/examples/libs/png/lv_example_png_1.d 

OBJS += \
./src/新建文件夹/LVGL/examples/libs/png/img_wink_png.o \
./src/新建文件夹/LVGL/examples/libs/png/lv_example_png_1.o 



# Each subdirectory must supply rules for building sources it contributes
src/新建文件夹/LVGL/examples/libs/png/%.o: ../src/新建文件夹/LVGL/examples/libs/png/%.c
