...
C_SRCS += \
../src/新建文件夹/LVGL/examples/assets/emoji/img_emoji_F617.c 

C_DEPS += \
./src/新建文件夹/LVGL/examples/assets/emoji/img_emoji_F617.d 

OBJS += \
./src/新建文件夹/LVGL/examples/assets/emoji/img_emoji_F617.o 



# Each subdirectory must supply rules for building sources it contributes
src/新建文件夹/LVGL/examples/assets/emoji/%.o: ../src/新建文件夹/LVGL/examples/assets/emoji/%.c
