...
C_SRCS += \
../src/新建文件夹/LVGL/src/extra/widgets/menu/lv_menu.c 

C_DEPS += \
./src/新建文件夹/LVGL/src/extra/widgets/menu/lv_menu.d 

OBJS += \
./src/新建文件夹/LVGL/src/extra/widgets/menu/lv_menu.o 



# Each subdirectory must supply rules for building sources it contributes
src/新建文件夹/LVGL/src/extra/widgets/menu/%.o: ../src/新建文件夹/LVGL/src/extra/widgets/menu/%.c
