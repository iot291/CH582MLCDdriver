...
C_SRCS += \
../src/新建文件夹/LVGL/src/extra/widgets/chart/lv_chart.c 

C_DEPS += \
./src/新建文件夹/LVGL/src/extra/widgets/chart/lv_chart.d 

OBJS += \
./src/新建文件夹/LVGL/src/extra/widgets/chart/lv_chart.o 



# Each subdirectory must supply rules for building sources it contributes
src/新建文件夹/LVGL/src/extra/widgets/chart/%.o: ../src/新建文件夹/LVGL/src/extra/widgets/chart/%.c
