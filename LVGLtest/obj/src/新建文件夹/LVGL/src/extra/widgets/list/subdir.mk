...
C_SRCS += \
../src/新建文件夹/LVGL/src/extra/widgets/list/lv_list.c 

C_DEPS += \
./src/新建文件夹/LVGL/src/extra/widgets/list/lv_list.d 

OBJS += \
./src/新建文件夹/LVGL/src/extra/widgets/list/lv_list.o 



# Each subdirectory must supply rules for building sources it contributes
src/新建文件夹/LVGL/src/extra/widgets/list/%.o: ../src/新建文件夹/LVGL/src/extra/widgets/list/%.c
