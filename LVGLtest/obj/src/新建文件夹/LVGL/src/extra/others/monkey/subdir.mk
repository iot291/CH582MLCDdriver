...
C_SRCS += \
../src/新建文件夹/LVGL/src/extra/others/monkey/lv_monkey.c 

C_DEPS += \
./src/新建文件夹/LVGL/src/extra/others/monkey/lv_monkey.d 

OBJS += \
./src/新建文件夹/LVGL/src/extra/others/monkey/lv_monkey.o 



# Each subdirectory must supply rules for building sources it contributes
src/新建文件夹/LVGL/src/extra/others/monkey/%.o: ../src/新建文件夹/LVGL/src/extra/others/monkey/%.c
