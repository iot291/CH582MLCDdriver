...
C_SRCS += \
../src/新建文件夹/LVGL/src/extra/others/ime/lv_ime_pinyin.c 

C_DEPS += \
./src/新建文件夹/LVGL/src/extra/others/ime/lv_ime_pinyin.d 

OBJS += \
./src/新建文件夹/LVGL/src/extra/others/ime/lv_ime_pinyin.o 



# Each subdirectory must supply rules for building sources it contributes
src/新建文件夹/LVGL/src/extra/others/ime/%.o: ../src/新建文件夹/LVGL/src/extra/others/ime/%.c
