...
C_SRCS += \
../src/新建文件夹/LVGL/src/extra/others/snapshot/lv_snapshot.c 

C_DEPS += \
./src/新建文件夹/LVGL/src/extra/others/snapshot/lv_snapshot.d 

OBJS += \
./src/新建文件夹/LVGL/src/extra/others/snapshot/lv_snapshot.o 



# Each subdirectory must supply rules for building sources it contributes
src/新建文件夹/LVGL/src/extra/others/snapshot/%.o: ../src/新建文件夹/LVGL/src/extra/others/snapshot/%.c
