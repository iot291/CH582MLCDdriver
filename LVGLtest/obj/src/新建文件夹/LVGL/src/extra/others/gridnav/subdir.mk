...
C_SRCS += \
../src/新建文件夹/LVGL/src/extra/others/gridnav/lv_gridnav.c 

C_DEPS += \
./src/新建文件夹/LVGL/src/extra/others/gridnav/lv_gridnav.d 

OBJS += \
./src/新建文件夹/LVGL/src/extra/others/gridnav/lv_gridnav.o 



# Each subdirectory must supply rules for building sources it contributes
src/新建文件夹/LVGL/src/extra/others/gridnav/%.o: ../src/新建文件夹/LVGL/src/extra/others/gridnav/%.c
