...
C_SRCS += \
../src/新建文件夹/LVGL/src/extra/libs/qrcode/lv_qrcode.c \
../src/新建文件夹/LVGL/src/extra/libs/qrcode/qrcodegen.c 

C_DEPS += \
./src/新建文件夹/LVGL/src/extra/libs/qrcode/lv_qrcode.d \
./src/新建文件夹/LVGL/src/extra/libs/qrcode/qrcodegen.d 

OBJS += \
./src/新建文件夹/LVGL/src/extra/libs/qrcode/lv_qrcode.o \
./src/新建文件夹/LVGL/src/extra/libs/qrcode/qrcodegen.o 



# Each subdirectory must supply rules for building sources it contributes
src/新建文件夹/LVGL/src/extra/libs/qrcode/%.o: ../src/新建文件夹/LVGL/src/extra/libs/qrcode/%.c
