...
C_SRCS += \
../src/新建文件夹/LVGL/src/extra/libs/bmp/lv_bmp.c 

C_DEPS += \
./src/新建文件夹/LVGL/src/extra/libs/bmp/lv_bmp.d 

OBJS += \
./src/新建文件夹/LVGL/src/extra/libs/bmp/lv_bmp.o 



# Each subdirectory must supply rules for building sources it contributes
src/新建文件夹/LVGL/src/extra/libs/bmp/%.o: ../src/新建文件夹/LVGL/src/extra/libs/bmp/%.c
