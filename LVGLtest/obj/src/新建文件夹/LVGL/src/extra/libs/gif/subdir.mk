...
C_SRCS += \
../src/新建文件夹/LVGL/src/extra/libs/gif/gifdec.c \
../src/新建文件夹/LVGL/src/extra/libs/gif/lv_gif.c 

C_DEPS += \
./src/新建文件夹/LVGL/src/extra/libs/gif/gifdec.d \
./src/新建文件夹/LVGL/src/extra/libs/gif/lv_gif.d 

OBJS += \
./src/新建文件夹/LVGL/src/extra/libs/gif/gifdec.o \
./src/新建文件夹/LVGL/src/extra/libs/gif/lv_gif.o 



# Each subdirectory must supply rules for building sources it contributes
src/新建文件夹/LVGL/src/extra/libs/gif/%.o: ../src/新建文件夹/LVGL/src/extra/libs/gif/%.c
