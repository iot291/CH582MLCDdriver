...
C_SRCS += \
../src/新建文件夹/LVGL/src/extra/libs/freetype/lv_freetype.c 

C_DEPS += \
./src/新建文件夹/LVGL/src/extra/libs/freetype/lv_freetype.d 

OBJS += \
./src/新建文件夹/LVGL/src/extra/libs/freetype/lv_freetype.o 



# Each subdirectory must supply rules for building sources it contributes
src/新建文件夹/LVGL/src/extra/libs/freetype/%.o: ../src/新建文件夹/LVGL/src/extra/libs/freetype/%.c
