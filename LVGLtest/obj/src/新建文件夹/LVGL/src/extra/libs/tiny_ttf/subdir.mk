...
C_SRCS += \
../src/新建文件夹/LVGL/src/extra/libs/tiny_ttf/lv_tiny_ttf.c 

C_DEPS += \
./src/新建文件夹/LVGL/src/extra/libs/tiny_ttf/lv_tiny_ttf.d 

OBJS += \
./src/新建文件夹/LVGL/src/extra/libs/tiny_ttf/lv_tiny_ttf.o 



# Each subdirectory must supply rules for building sources it contributes
src/新建文件夹/LVGL/src/extra/libs/tiny_ttf/%.o: ../src/新建文件夹/LVGL/src/extra/libs/tiny_ttf/%.c
