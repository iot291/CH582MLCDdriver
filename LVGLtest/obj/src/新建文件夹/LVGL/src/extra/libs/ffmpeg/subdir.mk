...
C_SRCS += \
../src/新建文件夹/LVGL/src/extra/libs/ffmpeg/lv_ffmpeg.c 

C_DEPS += \
./src/新建文件夹/LVGL/src/extra/libs/ffmpeg/lv_ffmpeg.d 

OBJS += \
./src/新建文件夹/LVGL/src/extra/libs/ffmpeg/lv_ffmpeg.o 



# Each subdirectory must supply rules for building sources it contributes
src/新建文件夹/LVGL/src/extra/libs/ffmpeg/%.o: ../src/新建文件夹/LVGL/src/extra/libs/ffmpeg/%.c
