...
C_SRCS += \
../src/新建文件夹/LVGL/src/extra/libs/rlottie/lv_rlottie.c 

C_DEPS += \
./src/新建文件夹/LVGL/src/extra/libs/rlottie/lv_rlottie.d 

OBJS += \
./src/新建文件夹/LVGL/src/extra/libs/rlottie/lv_rlottie.o 



# Each subdirectory must supply rules for building sources it contributes
src/新建文件夹/LVGL/src/extra/libs/rlottie/%.o: ../src/新建文件夹/LVGL/src/extra/libs/rlottie/%.c
