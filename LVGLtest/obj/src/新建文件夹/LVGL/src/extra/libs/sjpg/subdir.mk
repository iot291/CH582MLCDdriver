...
C_SRCS += \
../src/新建文件夹/LVGL/src/extra/libs/sjpg/lv_sjpg.c \
../src/新建文件夹/LVGL/src/extra/libs/sjpg/tjpgd.c 

C_DEPS += \
./src/新建文件夹/LVGL/src/extra/libs/sjpg/lv_sjpg.d \
./src/新建文件夹/LVGL/src/extra/libs/sjpg/tjpgd.d 

OBJS += \
./src/新建文件夹/LVGL/src/extra/libs/sjpg/lv_sjpg.o \
./src/新建文件夹/LVGL/src/extra/libs/sjpg/tjpgd.o 



# Each subdirectory must supply rules for building sources it contributes
src/新建文件夹/LVGL/src/extra/libs/sjpg/%.o: ../src/新建文件夹/LVGL/src/extra/libs/sjpg/%.c
