...
C_SRCS += \
../src/新建文件夹/LVGL/src/extra/libs/png/lodepng.c \
../src/新建文件夹/LVGL/src/extra/libs/png/lv_png.c 

C_DEPS += \
./src/新建文件夹/LVGL/src/extra/libs/png/lodepng.d \
./src/新建文件夹/LVGL/src/extra/libs/png/lv_png.d 

OBJS += \
./src/新建文件夹/LVGL/src/extra/libs/png/lodepng.o \
./src/新建文件夹/LVGL/src/extra/libs/png/lv_png.o 



# Each subdirectory must supply rules for building sources it contributes
src/新建文件夹/LVGL/src/extra/libs/png/%.o: ../src/新建文件夹/LVGL/src/extra/libs/png/%.c
