...
C_SRCS += \
../src/新建文件夹/LVGL/src/extra/layouts/flex/lv_flex.c 

C_DEPS += \
./src/新建文件夹/LVGL/src/extra/layouts/flex/lv_flex.d 

OBJS += \
./src/新建文件夹/LVGL/src/extra/layouts/flex/lv_flex.o 



# Each subdirectory must supply rules for building sources it contributes
src/新建文件夹/LVGL/src/extra/layouts/flex/%.o: ../src/新建文件夹/LVGL/src/extra/layouts/flex/%.c
