...
C_SRCS += \
../src/新建文件夹/LVGL/src/extra/layouts/grid/lv_grid.c 

C_DEPS += \
./src/新建文件夹/LVGL/src/extra/layouts/grid/lv_grid.d 

OBJS += \
./src/新建文件夹/LVGL/src/extra/layouts/grid/lv_grid.o 



# Each subdirectory must supply rules for building sources it contributes
src/新建文件夹/LVGL/src/extra/layouts/grid/%.o: ../src/新建文件夹/LVGL/src/extra/layouts/grid/%.c
