...
C_SRCS += \
../src/新建文件夹/LVGL/src/hal/lv_hal_disp.c \
../src/新建文件夹/LVGL/src/hal/lv_hal_indev.c \
../src/新建文件夹/LVGL/src/hal/lv_hal_tick.c 

C_DEPS += \
./src/新建文件夹/LVGL/src/hal/lv_hal_disp.d \
./src/新建文件夹/LVGL/src/hal/lv_hal_indev.d \
./src/新建文件夹/LVGL/src/hal/lv_hal_tick.d 

OBJS += \
./src/新建文件夹/LVGL/src/hal/lv_hal_disp.o \
./src/新建文件夹/LVGL/src/hal/lv_hal_indev.o \
./src/新建文件夹/LVGL/src/hal/lv_hal_tick.o 



# Each subdirectory must supply rules for building sources it contributes
src/新建文件夹/LVGL/src/hal/%.o: ../src/新建文件夹/LVGL/src/hal/%.c
